...
所有现代的JavaScript框架都有处理动态组件的方法。这篇文章将向你展示如何在Vue.JS中实现它，它为上面的场景提供了一个非常优雅简单的解决方案。
...
<iframe src="https://codesandbox.io/embed/github/e-schultz/vue-dynamic-components/tree/master" style="width:100%; height:500px; border:0; border-radius: 4px; overflow:hidden;" sandbox="allow-modals allow-forms allow-popups allow-scripts allow-same-origin"> </iframe>
